...
=== Step 3: Integrate Service Mesh with `cert-manager` and `istio-csr`
...
=== Step 4: Verify the certificates used in the _controlplane_ and _dataplane_ are from the new `istio-ca`.
