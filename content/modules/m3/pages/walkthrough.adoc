...
Then, login as `Mesh Operator` (credentials `emma/emma`), the script below will help you create the necessary configurations to allow metrics to be collected for controlplane and dataplane by the openshift monitoring stack.
